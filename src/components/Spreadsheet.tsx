  ...
  return (
    ...
    >
        ...
        <thead>
          <tr className="bg-gray-100">
            <th
              ...
              className="relative py-2 px-3 text-left text-xs font-medium text-gray-600 border-r border-gray-200"
            >
              <div
            ...
            <th
              ...
              className="relative py-2 px-3 text-right text-xs font-medium text-gray-600"
            >
              <span>Est. Value</span>
              <div
                className="absolute top-0 right-0 bottom-0 w-1 cursor-col-resize"
        ...
        <tbody>
          {mockData.map((row) => (
            ...
            >
              ...
              >
                <span
                  className={`px-2 py-1 rounded-sm ${getStatusClass(row.status)}`}
                >
      ...
      <div className="flex border-t border-gray-200 bg-gray-50">
        ...
        <div className="px-4 py-2 text-gray-600 text-sm">Pending</div>
        <div className="px-4 py-2 text-gray-600 text-sm">Reviewed</div>
        <div className="px-4 py-2 text-gray-600 text-sm">Arrived</div>
        <button
