      ...
      <div className="flex-1 overflow-auto">
        <table className="w-full">
          ...
          <thead>
            ...
            <tr>
              <th
                className="bg-[#F7F8FA] border border-[#E3E5E8] px-4 py-3"
                style={{ width: "80px" }}
              ></th>
              <th
                colSpan={5}
                className="bg-[#F7F8FA] border border-[#E3E5E8] px-6 py-3 text-left text-sm font-medium text-[#3B3F4C] tracking-wide"
              ...
              <th
                colSpan={1}
                className="bg-[#E3E5E8] border border-[#E3E5E8] px-3 py-2 text-center text-xs font-semibold text-[#4C2B2B] tracking-wide"
                style={{ minWidth: "120px" }}
              >
                <span className="inline-flex items-center">
                  <svg
              ...
              >
                <span className="flex items-center justify-between w-full">
                  <span className="flex items-center">
                    ...
                    >
                      <path
                        d="M7.99998 1.33333C11.6819 1.33333 14.6666 4.3181 14.6666 8C14.6666 11.6819 11.6819 14.6667 7.99998 14.6667C4.31808 14.6667 1.33331 11.6819 1.33331 8C1.33331 4.3181 4.31808 1.33333 7.99998 1.33333ZM4.97976 6.64644C4.7845 6.8417 4.7845 7.15829 4.97976 7.35355L7.64643 10.0202C7.84169 10.2155 8.15827 10.2155 8.35353 10.0202L11.0202 7.35355C11.2155 7.15829 11.2155 6.8417 11.0202 6.64644C10.8249 6.45118 10.5084 6.45118 10.3131 6.64644L7.99998 8.95955L5.68687 6.64644C5.4916 6.45118 5.17502 6.45118 4.97976 6.64644Z"
                        fill="#AFAFAF"
                      />
                      <path
                        d="M7.99998 1.33333C11.6819 1.33333 14.6666 4.3181 14.6666 8C14.6666 11.6819 11.6819 14.6667 7.99998 14.6667C4.31808 14.6667 1.33331 11.6819 1.33331 8C1.33331 4.3181 4.31808 1.33333 7.99998 1.33333ZM4.97976 6.64644C4.7845 6.8417 4.7845 7.15829 4.97976 7.35355L7.64643 10.0202C7.84169 10.2155 8.15827 10.2155 8.35353 10.0202L11.0202 7.35355C11.2155 7.15829 11.2155 6.8417 11.0202 6.64644C10.8249 6.45118 10.5084 6.45118 10.3131 6.64644L7.99998 8.95955L5.68687 6.64644C5.4916 6.45118 5.17502 6.45118 4.97976 6.64644Z"
                ...
                <span className="flex items-center justify-between w-full">
                  <span className="flex items-center">
                    ...
                    >
                      ...
                      />
                      <path
                        d="M8 2c2.21 0 4 2.69 4 6s-1.79 6-4 6-4-2.69-4-6 1.79-6 4-6z"
                        stroke="#AFAFAF"
                        strokeWidth="1"
                        fill="none"
                      />
            ...
            {Array.from({ length: 20 }, (_, index) => (
              <tr key={`empty-${index}`} className="hover:bg-gray-50">
                {columns.map((_, colIndex) => (
                  <td
                    ref={(el) => {
                      cellRefs.current[data.length + index] =
                        cellRefs.current[data.length + index] || [];
                      cellRefs.current[data.length + index][colIndex] = el;
                    }}
                    tabIndex={-1}
                    key={colIndex}
                    ...
                    onClick={() =>
                      handleCellClick(data.length + index, colIndex)
                    }
                    onDoubleClick={() =>
                      handleCellDoubleClick(data.length + index, colIndex)
                    }
                  >
